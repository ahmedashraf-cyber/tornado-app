import {
  PASS_TYPE_DROPDOWN, PASS_BODY_PART_OPTIONS, PASS_EXTRAS,
...
// Inline dropdown — matches video style: "• Label: [value ▾]"
...
// Inline text field — "• Label: [edit field]"
...
// Pass end: Incomplete badge — exactly as video: orange pill
...
export default function EventQualifierPanel({
  ...
  return (
    // Exact match to video: light gray background, single line, left-aligned, thin strip
